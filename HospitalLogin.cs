...
namespace Trail
{
    public partial class HospitalLogin : UserControl
    {
        public Form1 ob;
        public int ret = 0;
        ...
        public void setup()
        {
            ...
            cpl.Visible = false;
            mes.Visible = false;
            label2.Text = " City Hospital Managment Login";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                String s = "Select * from LoginH where HospitalManager_id='" + hid.Text + "'and Password='" + pass.Text + "';";
                Form1.con.Open();
                ...
                if (count > 0)
                {
                    ...
                    ob.hospital1.initialization(hid.Text);
                    ob.hospital1.Setvalue(ob);
                    hid.Clear();
                    pass.Clear();
                }
                else
        ...
        private void signUpToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            label2.Text = " City Hospital Managment SignUP";
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if (hhid.Text.CompareTo("")!=0 && p1.Text.CompareTo(cp1.Text)==0 &&p1.Text.CompareTo("")!=0 && cp1.Text.CompareTo("")!=0) {
                    String s = "insert into LoginH values('" + hhid.Text + "','" + p1.Text + "');";
                    Form1.con.Open();
                    SqlCommand ap = new SqlCommand(s, Form1.con);
                    ap.ExecuteNonQuery();
        ...
        private void label6_Click(object sender, EventArgs e)
        {
            ...
            ob.forgotPassword1.Setvalue(ob, 3);
        }
    }
}
